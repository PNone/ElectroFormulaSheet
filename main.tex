...
\textbf{קיצורים וסימונים:} $t' = t - r/c$, \quad $\vec{E} = \vec{B} \times \hat{r}$, \quad $\vec{U}_{\mathbf{Q}} \equiv \dddot{\mathbf{Q}} \cdot \hat{r}$, $\quad U_r \equiv \hat{r} \cdot \dddot{\mathbf{Q}} \cdot \hat{r}$. כאשר $(\dddot{\mathbf{Q}} \cdot \hat{r})_i = \sum_j \dddot{Q}_{ij} \hat{r}_j$}
...
& $0$ 
& $\dfrac{U_r}{3c^2 r}$ \\ \hline

$\vec{A}(\vec{r},t)$ 
& $0$ 
& $\dfrac{\dot{\vec{p}}}{cr}$ 
& $\dfrac{\dot{\vec{m}} \times \hat{r}}{cr}$ 
& $\dfrac{\vec{U}_{\mathbf{Q}}}{3c^2 r}$ \\ \hline
