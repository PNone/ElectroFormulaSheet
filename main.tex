...
\[
\phi(\vec{r}) = \frac{q}{r} + \frac{\vec{d} \cdot \vec{r}}{r^3} + \frac{1}{2} \sum_{i,j} Q_{ij} \frac{x_i x_j}{r^5} = \dfrac{q}{r} + \dfrac{d_i x_i}{r^3} + \frac{1}{2} Q_{ij} \dfrac{x_i x_j}{r^5}
\]
\noindent
...
\section*{קרינת מולטיפולים (שדה רחוק $r \gg \lambda \gg d$, יחידות CGS)}

\noindent
\textbf{קיצורים וסימונים:} $t' = t - r/c$, $\vec{E} = \vec{B} \times \hat{r}$. 
נגדיר $\vec{V}_{\mathbf{Q}} \equiv (\dddot{\mathbf{Q}} \cdot \hat{r}) \times \hat{r}$ כאשר $(\dddot{\mathbf{Q}} \cdot \hat{r})_i = \sum_j \dddot{Q}_{ij} \hat{r}_j$.
...
& $0$ 
& $\dfrac{\hat{r} \cdot \dddot{\mathbf{Q}} \cdot \hat{r}}{6c^2 r}$ \\ \hline

$\vec{A}(\vec{r},t)$ 
& $0$ 
& $\dfrac{\dot{\vec{p}}}{cr}$ 
& $\dfrac{\dot{\vec{m}} \times \hat{r}}{cr}$ 
& $\dfrac{\dddot{\mathbf{Q}} \cdot \hat{r}}{6c^2 r}$ \\ \hline

$\vec{B}(\vec{r},t)$ 
& $0$ 
& $\dfrac{\ddot{\vec{p}} \times \hat{r}}{c^2 r}$ 
& $\dfrac{(\ddot{\vec{m}} \times \hat{r}) \times \hat{r}}{c^2 r}$ 
& $\dfrac{\vec{V}_{\mathbf{Q}}}{6c^3 r}$ \\ \hline

$\vec{E}(\vec{r},t)$ 
& $\dfrac{q\hat{r}}{r^2}$ 
& $\dfrac{(\ddot{\vec{p}} \times \hat{r}) \times \hat{r}}{c^2 r}$ 
& $\dfrac{\ddot{\vec{m}} \times \hat{r}}{c^2 r}$ 
& $\dfrac{\vec{V}_{\mathbf{Q}} \times \hat{r}}{6c^3 r}$ \\ \hline

$\dfrac{dP}{d\Omega}$ 
& $0$ 
& $\dfrac{|\ddot{\vec{p}} \times \hat{r}|^2}{4\pi c^3}$ 
& $\dfrac{|\ddot{\vec{m}} \times \hat{r}|^2}{4\pi c^3}$ 
& $\dfrac{|\vec{V}_{\mathbf{Q}}|^2}{144\pi c^5}$ \\ \hline

$P_{\text{total}}$ 
& $0$ 
& $\dfrac{2}{3c^3}|\ddot{\vec{p}}|^2$ 
& $\dfrac{2}{3c^3}|\ddot{\vec{m}}|^2$ 
& $\dfrac{1}{180 c^5} \sum\limits_{i,j} |\dddot{Q}_{ij}|^2$ \\ \hline
\end{tabularx}
\endgroup
