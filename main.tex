...
\begin{itemize}
    ...
    \item \textbf{משוואות אוילר-לגראנז' לשדה ($A_\nu$):}
    \[
    ...
    \item \textbf{הצבה וואריאציה ($\delta S = 0$) $\Leftarrow$ משוואות מקסוול לא-הומוגניות:}
    \[
    \partial_\mu F^{\mu\nu} = \frac{4\pi}{c} J^\nu
    \]
\end{itemize}
